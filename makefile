...
emcc: main.c
	emcc main.c -s USE_SDL=2 -s USE_SDL_TTF=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='["png"]' -s WASM=1 --shell-file html_template/resize-with-aspect-ratio.html -s USE_OGG=1 -s USE_VORBIS=1 -o docs/index.html -O2 --preload-file assets
